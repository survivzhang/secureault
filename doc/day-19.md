...
- An invalid/expired token is a *credentials* problem → should be **401**, not 403. The backend
  was mislabeling it. (Also: a real *expired* token throws in `jwt.verify` too → would've been 403
